    ...
    return (
        <div className="hidden sm:flex flex-col items-center 
            ...
            <button className="hidden xl:inline ml-auto bg-[#1d9bf0]
             text-[#d9d9d9] rounded-full w-52 h-[56px] text-lg 
             font-bold shadow-md hover:bg-[#1aacda]">Tweet
             </button>
             <div className="text-[#d9d9d9] flex items-center 
             justify-center xl:ml-auto hoverAnimation xl:-mr-5 mt-auto " onClick={signOut}>
                 <img 
